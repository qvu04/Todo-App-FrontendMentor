...
const Todo = () => {
    ...
    return (
        <div className='min-h-screen dark:bg-neutral-950 md:flex md:flex-col md:items-center'>
            <div className='bg-[url(/images/bg-mobile-light.jpg)] md:bg-[url(/images/bg-desktop-light.jpg)] relative md:flex md:flex-col md:items-center md:justify-start bg-no-repeat bg-size-[100%_250px] h-70 w-full'>
                <div className='flex justify-evenly items-start'>
                    ...
                    <button onClick={toggleTheme} className='mt-10 ml-20 '><img src={isDarkMode ? "/images/icon-sun.svg" : "/images/icon-moon.svg"} alt="moon" /></button>
                </div>
